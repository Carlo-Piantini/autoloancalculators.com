...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$auto_loan_calculators_description = get_bloginfo( 'description', 'display' );
			if ( $auto_loan_calculators_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $auto_loan_calculators_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
